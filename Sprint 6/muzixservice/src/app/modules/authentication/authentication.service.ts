...
export class AuthenticationService {
  ...
  private SpringLoginEndPoint: string;
   ...
   constructor(private httpclient: HttpClient) {
    ...
    // this.SpringRegisterEndPoint = 'http://localhost:8086/orchestrationservice/api/v1/user'; //S5_s6C
    this.SpringRegisterEndPoint = 'http://localhost:8086/usertrackservice/api/v1/usertrackservice/register '; // s6
